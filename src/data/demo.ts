...
export type ContentItem = { id: string; type: ContentType; category: Category; title: string; description: string; author: string; locationName: string; longitude: number; latitude: number; distanceM: number; createdAt: string; startAt?: string; endAt?: string; likes: number; comments: number };
